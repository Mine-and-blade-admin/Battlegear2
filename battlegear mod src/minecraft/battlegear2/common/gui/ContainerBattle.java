...
public class ContainerBattle extends Container{
	...
	public ContainerBattle(InventoryPlayer inventoryPlayer, boolean local, EntityPlayer player){
		...
		//Weapon Slots
        for(int x = 0; x < 3; x++){
        	WeaponSlot main = new WeaponSlot(inventoryPlayer, x+InventoryPlayer.offset, 97, 15+x*18, true);
        	WeaponSlot offhand = new WeaponSlot(inventoryPlayer, x+InventoryPlayer.offset+3, 137, 15+x*18, false);
