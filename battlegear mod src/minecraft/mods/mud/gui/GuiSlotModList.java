        ...
        else
        {
            ...
            try{
                if(entries.get(listIndex).isUpToDate()){
                    this.parent.getFontRenderer().drawString(this.parent.getFontRenderer().trimStringToWidth(StatCollector.translateToLocal("mud.version.latest"), listWidth - 10), this.left + 3 , var3 + 12, 0xFF00FF00);
                }else{
                    this.parent.getFontRenderer().drawString(this.parent.getFontRenderer().trimStringToWidth(StatCollector.translateToLocal("mud.version.out"), listWidth - 10), this.left + 3 , var3 + 12, 0xFFFF0000);
                }
