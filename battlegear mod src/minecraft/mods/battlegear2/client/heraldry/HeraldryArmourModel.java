			...
			if(stack != null && heraldryItem.hasHeraldry(stack)){
	            ...
	            if(armourSlot == 1){
	            	...
	            	if(!sigil.equals(HeraldryIcon.Blank)){
		            	...
		            	GL11.glMatrixMode(GL11.GL_TEXTURE);
				    	FMLClientHandler.instance().getClient().renderEngine.bindTexture(sigil.getForegroundImagePath());
				    	GL11.glLoadIdentity();
			            GL11.glMatrixMode(GL11.GL_MODELVIEW);
		            	...
		            	GL11.glMatrixMode(GL11.GL_TEXTURE);
		    	    	FMLClientHandler.instance().getClient().renderEngine.bindTexture(sigil.getBackgroundImagePath());
		    	    	GL11.glLoadIdentity();
		                GL11.glMatrixMode(GL11.GL_MODELVIEW);
