        ...
        switch (par1GuiButton.id){
            case ID_OK:
                ...
                if(stack != null && stack.getItem() instanceof IHeraldryItem){
                    ...
                    PacketDispatcher.sendPacketToServer(new BattlegearChangeHeraldryPacket(player.getCommandSenderName(), ((IHeraldryItem) stack.getItem()).getHeraldry(stack)).generatePacket());
                    this.keyTyped('c',1);
                }
                break;
            case ID_SAVE:
