...
public class BattlegearFakeGUI extends GuiScreen{
    ...
    public void initGui(){
        ...
        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, this.height - 25, StatCollector.translateToLocal("gui.done")));
    ...
    public void drawScreen(int mouseX, int mouseY, float frame){
        ...
        /*for(Object obj:this.buttonList)
            if(((GuiButton)obj).func_146115_a()){
                drawCreativeTabHoveringText(StatCollector.translateToLocal("gui.fake.help" + ((GuiButton) obj).id), mouseX, mouseY);
            }*/
    }
