...
public abstract class LayerPlayerBase implements LayerRenderer<AbstractClientPlayer>{
    ...
    @Override
    public final void doRenderLayer(@Nonnull AbstractClientPlayer clientPlayer, float partialLimbSwing, float partialLimbSwingAmount, float partialTicks, float partialTickExisted, float partialRotationYaw, float partialRotationPitch, float scale) {
